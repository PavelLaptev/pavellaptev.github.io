...
const articlesData = [
  ...
  },
  {
    ...
    url: "https://pavellaptev.medium.com/professor-spot-and-inputs-validation-in-framer-x-83da6d35f771",
    date: "Nov 13, 2018"
  },
  {
...
const Articles: React.FC = () => {
  return (
    <Section
      ...
      description={
        <>
          I love to make and share things, but I also love to write about them.
          By writing I can explain how I did something not only to myself, but
          to others as well. I hope you find these posts useful.
        </>
      }
    >
      {
